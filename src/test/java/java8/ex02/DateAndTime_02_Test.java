...
public class DateAndTime_02_Test {
    ...
    public void test_with() {
        ...
        LocalDate newLocalDate1 = localDate.withYear(2015);
        LocalDate newLocalDate2 = newLocalDate1.withMonth(2);
        LocalDate newLocalDate3 = newLocalDate2.withDayOfMonth(5);
        LocalDate result = newLocalDate3;
